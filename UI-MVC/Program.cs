...
builder.Services.AddDbContext<PadelClubManagementDbContext>(options => options.UseNpgsql("Host=34.77.69.181;Port=5432;Database=codeforge;Username=admin;Password=123"));
